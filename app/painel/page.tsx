        ...
        <div className="pl-3 pt-6 flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              <span className={`px-3 py-1 rounded-full text-xs font-extrabold border ${pillClass(p.status)}`}>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-2xl border text-sm font-semibold ${
                soundOn ? "bg-white border-slate-200 text-slate-800" : "bg-slate-900 border-slate-900 text-white"
              }`}
        ...
        <div className="fixed inset-0 bg-black/30 flex items-end md:items-center justify-center z-50">
          <div className="bg-white w-full md:max-w-xl rounded-t-3xl md:rounded-3xl p-4 md:p-5">
            ...
            <div className="space-y-2 max-h-[52vh] overflow-auto pr-1">
              {produtos.map((p) => (
                <div key={p.id} className="flex items-center justify-between gap-3 py-2 border-b border-slate-100">
                  <div className="min-w-0">
            ...
            <div className="mt-3">
              <div className="text-[11px] uppercase tracking-wider text-slate-500 font-semibold">Local (opcional)</div>
              <input
                value={local}
            ...
            <div className="mt-3">
              <div className="text-[11px] uppercase tracking-wider text-slate-500 font-semibold">Forma de pagamento</div>
