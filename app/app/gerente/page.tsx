...
export default function GerentePage() {
  ...
  useEffect(() => {
    // resolve inicialmente + reage a navegação
    const apply = () => setBarracaId(resolveBarracaId());
    apply();
      ...
      <div className="wavie-card p-6">
        ...
        <div className="mt-2 text-sm text-[color:var(--text-2)]">
          ...
          <div className="mt-2 text-xs text-[color:var(--muted)]">
            <div className="font-semibold">/app/barraca/SEU_UUID/gerente</div>
            <div className="mt-1">ou</div>
            <div className="font-semibold">/app/gerente?barraca_id=SEU_UUID</div>
          </div>
        </div>
      </div>
    );
